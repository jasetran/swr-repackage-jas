...
const midBlockTrialsContent = [
  {
    ...
    <div>
      ...
      <div class = "story-scene">
        <img class="scene" src="${
          mediaAssets.images.halfValley
        }" alt="background image with hills and trees">
        <img class = 'adventure_mid_break' src="${
          mediaAssets.images.adventurer1
        }" alt="adventurer with harp">
      </div>
    </div>
    ${
      !isTouchScreen
  ...
  },
  {
    ...
    <div>
      ...
      <div class="story-scene">
        <img class="scene" src="${
          mediaAssets.images.valley4
        }" alt="background with hills and trees">
        <img class = 'adventure_mid_break' src="${
          mediaAssets.images.adventurer1
        }" alt="adventurer with harp">
        <img class = 'adventure_mid_break' src="${
  ...
  },
  {
    ...
    <div>
      ...
      <div class="story-scene">
        <img class="scene" src="${
          mediaAssets.images.valley3
        }" alt="backgroun image with hills and trees">
        <img class = 'adventure_mid_break'  src="${
          mediaAssets.images.adventurer1
        }" alt="adventurer with harp">
        <img class = 'adventure_mid_break'  src="${
          mediaAssets.images.adventurer3
        }" alt="adventurer playing rainbow">
        <img class = 'adventure_mid_break'  src="${
    ...
    <div>
      ...
      <div>
        ...
        <p class="center">${i18next.t(
          "gameBreakTrials.postBlockTrials.trial1.paragraph2",
        )}</p>
      </div>
      <div class = "story-scene">
        <img class="scene" src="${
          mediaAssets.images.valley
        }" alt="background image of hills and trees">
        <img class='wizard' src="${
          mediaAssets.images.wizardCoin
        }" alt="adventure playing rainbow">
        <img class="guardian" src="${
          mediaAssets.images.guardian1
        }" alt="adventure making heart shapes">
      </div>
    </div>
    ${
      !isTouchScreen
  ...
  },
  {
    ...
    <div>
      ...
      <div>
        ...
        <p class="center">${i18next.t(
          "gameBreakTrials.postBlockTrials.trial2.paragraph2",
        )}</p>
      </div>
      <div class="story-scene">
        <img class="scene" src="${
          mediaAssets.images.valley5
        }" alt="background image of hills and trees">
        <img class='wizard' src="${
          mediaAssets.images.wizardCoin
        }" alt="adventure playing rainbow">
        <img class='guardian' src="${
          mediaAssets.images.guardian2
        }" alt="adventure making heart shapes">
      </div>
    </div>
    ${
...
const final_page = {
  ...
  <div>
    ...
    <div>
      <p class="center" style="margin-bottom: 1.5rem;">${i18next.t(
        "gameBreakTrials.finalTrial.paragraph1",
      )}</p>
      <p class="center">${i18next.t(
        "gameBreakTrials.finalTrial.paragraph2",
      )}</p>
    </div>
    <div class="story-scene">
      <img class="scene" src="${
        mediaAssets.images.endingBackground
      }" alt="background image of gate">
      <img class='guardian' src="${
        mediaAssets.images.guardian3
      }" alt="image of a unicorn winking">
      <img class='guardian' id = "gate" src="${
        mediaAssets.images.endingGateCoinbag
      }" alt="gate">
    </div>
  </div>
  ${
